...
var
  ...
  ZXTune_GetPlayerParameterInt: function(player: ZXTuneHandle; paramName: PAnsiChar; paramValue: PInteger): Boolean; cdecl;
  ...
  // НОВАЯ ФУНКЦИЯ - позиция с учетом loop
  ZXTune_GetPositionMsWithLoop: function(player: ZXTuneHandle; const moduleInfo: PZXTuneModuleInfo): LongInt; cdecl;
  ...
  ZXTune_SetDoneSamples: function(player: ZXTuneHandle; setSample: NativeUInt): Boolean; cdecl;
...
begin
  ...
  try
    ...
    // Новая функция
    LoadProc(ZXTune_GetPositionMsWithLoop, 'ZXTune_GetPositionMsWithLoop');
